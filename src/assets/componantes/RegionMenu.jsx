...
const RegionMenu = ({countriesList,filtersCountriesList} ) => {
 const handleRegionChange=(e)=>{
const region= e.label
const filterdCountries= region=== "All regions" ? countriesList:countriesList.filter((country)=>country.region===region);
